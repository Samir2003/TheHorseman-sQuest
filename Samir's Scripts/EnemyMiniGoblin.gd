...
onready var enemy2d = get_node("/root/Level/EnemyMiniGoblin")
onready var enemy = get_node("/root/Level/EnemyMiniGoblin/EnemyMiniGoblin1")
func _ready():
...
func _physics_process(delta):
		...
		if dir.x < 1:
				...
				$AnimatedMiniGoblin.flip_h = dir.x > 0 
		else:
				move_and_collide(dir * SPEED * delta)
...
func TakeDamage():
		if (health == 1):
			...
			$AnimatedMiniGoblin.animation = "Death"
